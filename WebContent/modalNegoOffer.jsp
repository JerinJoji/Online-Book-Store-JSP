...
<form action="adminNegotiateOffer.jsp" method="post">
<%
	...
	<table class="table table-striped table-bordered">
		...
		<tr>
  		...
  		<tr>
    		...
    		<td><%=rs.getString("SCustDesp")%></td>
  		</tr>
  		
  		<tr>
    		<th>Admin Description</th>
    		<td><textarea rows="4" cols="35" name="sadmindesp"></textarea></td>
  		</tr>
  		
  		<tr>
  			<td >
  			<a href="adminAcceptOffer.jsp?sellid=<%=rs.getString(1) %>" class="btn-logout" style="margin:9px 0">Accept</a><br>
  			<a href="adminDeclineOffer.jsp?sellid=<%=rs.getString(1) %>" class="btn-logout" style="margin:9px 0">Decline</a>
  			</td>
